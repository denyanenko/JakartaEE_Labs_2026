...
<head>
    ...
    <style>
        body { background-color: #f4f7f6; color: #333; margin: 40px; }
        h1 { color: #2c3e50; }
        ...
        .admin-panel { background: #fee; border: 1px solid #fcc; padding: 10px; margin-bottom: 20px; border-radius: 4px; }
    </style>
</head>
<body>
...
<div class="container">
    ...
    <div class="search-box">
        <form action="games" method="get">
            <input type="text" name="search" placeholder="Пошук команди..." value="<c:out value='${searchQuery}'/>">
            <button type="submit">Шукати</button>
            <a href="games">Скинути</a>
        </form>
    </div>

    <!-- 2.3) JSTL forEach: Listing games -->
    <table>
        <thead>
            <tr>
                <th>Дата та час</th>
        ...
        <tbody>
            <c:forEach var="game" items="${games}">
                <tr>
                    ...
                    <td><strong><c:out value="${game.homeTeam}"/></strong></td>
                    <td><strong><c:out value="${game.awayTeam}"/></strong></td>
                    <td>
                        <!-- 2.2) JSTL Choose: Display result or placeholder -->
                        <c:choose>
