...
public class GameDAO implements IGameDAO {
    ...
    public Game create(Game game) {
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            Team homeTeam = getOrCreateTeam(conn, game.getHomeTeam().getName());
            Team awayTeam = getOrCreateTeam(conn, game.getAwayTeam().getName());

            stmt.setLong(1, homeTeam.getId());
            stmt.setLong(2, awayTeam.getId());
